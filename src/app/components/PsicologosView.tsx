...
export function PsicologosView({ userId, isDemo = false, onDemoAction }: PsicologosViewProps) {
...
function PsychologistCard({ psychologist, onViewProfile, isDemo = false, onDemoAction }: PsychologistCardProps) {
