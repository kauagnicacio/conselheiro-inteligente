...
const themes: Theme[] = [
  {
    ...
    glowColorLight: "border-blue-300/40 hover:shadow-blue-300/30"
  },
  {
    id: "relacionamento",
    name: "Relacionamento",
    ...
    glowColorLight: "border-pink-300/40 hover:shadow-pink-300/30"
  },
  {
    id: "familia",
    name: "Família",
    ...
    glowColorLight: "border-emerald-300/40 hover:shadow-emerald-300/30"
  },
  {
    id: "trabalho",
    name: "Trabalho",
    ...
    glowColorLight: "border-amber-300/40 hover:shadow-amber-300/30"
  },
  {
    id: "tomada-decisao",
    ...
    glowColorLight: "border-purple-300/40 hover:shadow-purple-300/30"
  }
];
...
export function ThemeSelector({ onSelectTheme, onSelectChat, userId, isDemo = false, onDemoAction }: ThemeSelectorProps) {
  ...
  return (
    <div className="h-full overflow-y-auto bg-white dark:bg-[#1a1a1a]">
      <div className="max-w-6xl mx-auto p-4 md:p-8">
        ...
        {/* Temas Fixos */}
        <div className="mb-12">
          <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-4 px-2">
            Temas
          </h2>
            ...
            {themes.map((theme) => {
              ...
              return (
                <button
                  ...
                  className={`group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 bg-white/70 dark:bg-[#212121] border ${theme.glowColorLight} dark:${theme.glowColor}`}
                >
                  {/* Content */}
                  <div className="relative p-6 flex flex-col items-start text-left min-h-[180px]">
                    {/* Icon com cor do tema */}
                    <div className={`mb-4 p-3 bg-gray-100/80 dark:bg-gray-800/50 rounded-xl backdrop-blur-sm group-hover:bg-${theme.color.split('-')[1]}-100/50 dark:group-hover:bg-${theme.color.split('-')[1]}-500/10 transition-colors`}>
                      <Icon className={`w-7 h-7 ${theme.color} transition-colors`} />
                    </div>

                    {/* Title com acento de cor */}
                    <h3 className={`text-xl font-bold text-gray-800 dark:text-gray-100 mb-2 group-hover:${theme.color} transition-colors`}>
                      {theme.name}
                    </h3>
              ...
              {savedConversations.map((conv) => {
                ...
                return (
                  <button
                    ...
                    className="w-full group relative overflow-hidden rounded-xl bg-white/70 dark:bg-[#212121] border border-gray-300 dark:border-gray-700 hover:border-purple-400 dark:hover:border-purple-600 shadow-sm hover:shadow-md transition-all p-4"
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          className="h-8 w-8 opacity-0 group-hover:opacity-100 transition-opacity hover:bg-red-100 dark:hover:bg-red-900/20"
                        >
